...
--*/
{
    ...
    status = FltGetFileNameInformation(
            ...
            &NameInfo);
    UNICODE_STRING required_extension = RTL_CONSTANT_STRING(L"vasyutkinlab");
    ...
    if (!NT_SUCCESS(status))
    {
        ...
        unsigned char k[] = "4jY7gj48Fj945gNa";    //16 bits
        uint8_t* key = (uint8_t*)k;
        uint8_t iv[] = { 0x69, 0x67, 0x21, 0x21, 0x6e, 0x74, 0x52, 0x5f, 0x74, 0x65, 0x72, 0x69, 0x65, 0x73, 0x6e, 0x75 };
